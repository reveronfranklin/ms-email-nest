...
//Misocio
const CLIENT_ID = process.env.CLIENT_ID_MISOCIO;
const CLIENT_SECRET = process.env.CLIENT_SECRET_MISOCIO;
const REDIRECT_URI = process.env.REDIRECT_URI;
const REFRESH_TOKEN = process.env.REFRESH_TOKEN_MISOCIO;
const EMAIL = process.env.EMAIL_MISOCIO;
  ...
  async sendEmail(subjectEmail, sendTo, html, bcc, cc) {
    ...
    try {
      const info = await transport.sendMail({
        from: '"Moore Venezuela" <misocio@moore.com.ve>', // sender address
